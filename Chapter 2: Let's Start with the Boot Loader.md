...
[fig-a-platter] ![(A) Shows a platter when we see it from the side. (B) Shows a platter when we see it from top/down.](Figures/bootloader-ch/a-platter.png){ width=50% }
...
[fig-platters-arms-heads] ![Shows how the parts of a hard disk are assembled together.](Figures/bootloader-ch/platters-arms-heads.png){ width=50% }
...
[fig-tracks-sectors] ![Shows Tracks and Sectors on a platter's surface.](Figures/bootloader-ch/tracks-sectors.png){ width=50% }
